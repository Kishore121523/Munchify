  ...
  return (
    <div>
      <div className="flex flex-col gap-[20px]" id="explore-menu">
        ...
        <p className="text-center mx-auto max-w-[80%] text-textGray text-[18px]">
          ...
          {menu_list.map((_menuItem, _index)=>{
            return (
              <div 
                ...
                className="">
                <img 
                  className={`${category === _menuItem.menu_name ? "border-[4px] border-solid border-tomato p-[2px]":""} 
                  w-[7.5vw] min-w-[80px] cursor-pointer rounded-[50%] duration-200`} 
                  src={_menuItem.menu_image} 
                  alt="menu image"/>
                <p className="mt-[10px] text-textGray text-[16px] cursor-pointer">
                  {_menuItem.menu_name}
                </p>
              </div>
            )
